	...
	<div id="fullpage">
	  <div id="ap">
		<div id="login">
			...
			<p><button class="button" v-on:click="user_login">登录</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="button" v-on:click="">取消</button></p>
		</div>
	  </div>
	</div>
</template>
...
<style>
	#fullpage {
	  background-image: url(../assets/5f7531dced9766bfb3d839d7f9201664.png);
